...
def main():
    parser = argparse.ArgumentParser(formatter_class=CustomFormatter,
                                     description="Generate a .png image of a specified marker.")
    parser.add_argument('--id', default=123, type=int,
    ...
    _, marker_binary = cv2.threshold(image, 127, 1, cv2.THRESH_BINARY)

    #print (marker_binary)
    cv2.imwrite("marker_aruco_original{:04d}.png".format(args.id), image)
